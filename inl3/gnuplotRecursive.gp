...
set output "recursive_search_plot.pdf"

set title "Recursive Binary Search Execution Time"
...
plot "recursiveBench.txt" using ($1/1000):2 with linespoints title "Binary Search" lt rgb "blue" lw 2
